...
namespace VirusGame
{
    ...
    public class Level2old
    {
        ...
        public Level2old(ContentManager serviceProvider, GraphicsDevice graphicDevice)
        {
        ...
        protected void LoadTiles()
        {
            ...
            using (Stream stream = TitleContainer.OpenStream("Content/Levels/level2.gleed")) //#1 change gere you level file path
            {
