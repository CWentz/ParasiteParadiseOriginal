...
namespace VirusGame.SpriteClasses.BloodControl
{
    ...
    public class BloodSpawner : MovingSprite
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (!open)
            {
                spawnAmount = (int)(spawnAmount * scale * Globals.GlobalScale);
            }
            ...
            foreach (SpriteClasses.NPCSprites.BloodCell bloodCell in bloodList)
            {
                ...
                if (bloodCell.Timer <= timer / 2f && !bloodCell.wallCollide)
                {
                    bloodCell.wallCollide = true;
                }
                ...
                if (!Open)
                {
                    bloodCell.velocity = bloodCell.InitialVelocity / new Vector2(2, 2);
                }
                else
                {
